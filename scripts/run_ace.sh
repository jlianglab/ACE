...
CUDA_VISIBLE_DEVICES=3 torchrun --nproc_per_node=1 main.py --arch swin_base --batch_size_per_gpu 8 --data_path /data/jliang12/shared/dataset/NIHCXR14/full_images/images --output_dir /scratch/ssiingh/JLiangLab/ACE/outputs --saveckp_freq 1 --cfg /scratch/ssiingh/JLiangLab/ACE/swin_configs/swinv2_base_patch4_window16_256.yaml
