...
CUDA_VISIBLE_DEVICES="0,1,2,3" python -m torch.distributed.launch --nproc_per_node=4 --master_port 28301 main.py --arch swin_base --batch_size_per_gpu 16 --data_path /data/jliang12/shared/dataset/NIHCXR14/full_images/images --output_dir /scratch/ssiingh/JLiangLab/ACE/outputs/local_comp_decomp --saveckp_freq 1 --cfg /scratch/ssiingh/JLiangLab/ACE/swin_configs/swin_base_img224_window7.yaml
