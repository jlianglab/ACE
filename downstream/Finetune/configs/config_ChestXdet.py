...
_C.OUTPUT = '/sda1/zhouziyu/ssl/downstream_checkpoints/ChestXdet/'
...
_C.DATA.DATA_PATH = '/sda1/zhouziyu/ssl/dataset/ChestX-Det/allimages/'
_C.DATA.MASK = '/sda1/zhouziyu/ssl/dataset/ChestX-Det/allmasks/'
...
_C.DATA.TRAIN_LIST = '/sda1/zhouziyu/ssl/dataset/ChestX-Det/data_files/ChestX-Det_train_data.txt'
_C.DATA.VAL_LIST = '/sda1/zhouziyu/ssl/dataset/ChestX-Det/data_files/ChestX-Det_valid_data.txt'
_C.DATA.TEST_LIST = '/sda1/zhouziyu/ssl/dataset/ChestX-Det/data_files/ChestX-Det_test_data.txt'
