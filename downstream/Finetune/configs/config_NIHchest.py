...
_C.OUTPUT = '/mnt/sda/zhouziyu/ssl/downstream_checkpoints/NIHchest/'
...
_C.DATA.TRAIN_LIST = './data/data_split/xray14/official/train_official.txt'
_C.DATA.VAL_LIST = './data/data_split/xray14/official/val_official.txt'
_C.DATA.TEST_LIST = './data/data_split/xray14/official/test_official.txt'
