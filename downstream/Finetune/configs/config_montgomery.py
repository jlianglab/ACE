...
_C.OUTPUT = '/sda1/zhouziyu/ssl/downstream_checkpoints/Montgomery/'
...
_C.DATA.IMAGE = '/sda1/zhouziyu/ssl/dataset/MontgomerySet/CXR_png'
_C.DATA.MASK = '/sda1/zhouziyu/ssl/dataset/MontgomerySet/ManualMask/LeftRightMask'

# # dataset name
_C.DATA.DATASET = 'NIHchest'
# dataset lists and labels
_C.DATA.TRAIN_LIST = '/data/zhouziyu/home3/zhouziyu/warmup/sslpretrain/Swin-Transformer/data/data_split/Montgomery/train.txt'
_C.DATA.VAL_LIST = '/data/zhouziyu/home3/zhouziyu/warmup/sslpretrain/Swin-Transformer/data/data_split/Montgomery/val.txt'
_C.DATA.TEST_LIST = '/data/zhouziyu/home3/zhouziyu/warmup/sslpretrain/Swin-Transformer/data/data_split/Montgomery/test.txt'
...
def get_config_Montgomery(args):
