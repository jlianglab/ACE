...
_C.OUTPUT = "/sda/zhouziyu/ssl/downstream_checkpoints/shenzhenCXR"
...
_C.DATA.DATA_PATH = "/sda/zhouziyu/ssl/datasets/ChestXray/shenzhenCXR/images/images/"
# dataset name
_C.DATA.DATASET = 'shenzhenCXR'
# dataset lists and labels
_C.DATA.TRAIN_LIST = '/mnt/nvme1n1/zhouziyu/Swin-Transformer/data/data_split/shenzhen/ShenzenCXR_train_data.txt'
_C.DATA.VAL_LIST = '/mnt/nvme1n1/zhouziyu/Swin-Transformer/data/data_split/shenzhen/ShenzenCXR_valid_data.txt'
_C.DATA.TEST_LIST = '/mnt/nvme1n1/zhouziyu/Swin-Transformer/data/data_split/shenzhen/ShenzenCXR_test_data.txt'
...
_C.MODEL.SWINV2.WINDOW_SIZE = 16
...
def update_config(config, args):
    ...
    if config.DATA.IMG_SIZE == 448:
        if config.LINEAR_PROB:
            config.OUTPUT = os.path.join(config.OUTPUT, config.PRETRAIN_MODE+config.MODEL.TYPE+'_linearprob_448_'+config.DATA.FOLD)
        else:
            config.OUTPUT = os.path.join(config.OUTPUT, config.PRETRAIN_MODE+config.MODEL.TYPE+'_448_'+config.DATA.FOLD)
    elif config.DATA.IMG_SIZE == 224:
        config.OUTPUT = os.path.join(config.OUTPUT, config.PRETRAIN_MODE+config.MODEL.TYPE+'_224_'+config.DATA.FOLD)
    elif config.DATA.IMG_SIZE == 512:
        if config.LINEAR_PROB:
            config.OUTPUT = os.path.join(config.OUTPUT, config.PRETRAIN_MODE+config.MODEL.TYPE+'_linearprob_512_'+config.DATA.FOLD)
        else:
            config.OUTPUT = os.path.join(config.OUTPUT, config.PRETRAIN_MODE+config.MODEL.TYPE+'_512_'+config.DATA.FOLD)
