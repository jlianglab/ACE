...
_C.OUTPUT = '/mnt/sdb1/zhouziyu/ssl/downstream_ckpt/eyepacs/'
...
_C.DATA.DATA_PATH = '/mnt/sdb1/zhouziyu/ssl/dataset/EyePACS/train/train/'
# dataset name
_C.DATA.DATASET = 'eyepacs'
# dataset lists and labels
_C.DATA.LABEL_PATH = '/mnt/sdb1/zhouziyu/ssl/dataset/EyePACS/trainLabels.csv'
_C.DATA.TRAIN_LIST = '/mnt/sdd1/zhouziyu/ssl/Swin-Transformer/data/data_split/EyePACS/downstream_train.txt'
_C.DATA.VAL_LIST = '/mnt/sdd1/zhouziyu/ssl/Swin-Transformer/data/data_split/EyePACS/downstream_val.txt'
_C.DATA.TEST_LIST = '/mnt/sdd1/zhouziyu/ssl/Swin-Transformer/data/data_split/EyePACS/downstream_test.txt'
