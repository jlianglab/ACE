...
_C.OUTPUT = '/sda/zhouziyu/ssl/downstream_checkpoints/CovidQuEx/'
...
_C.DATA.DATA_PATH = '/mnt/sda/zhouziyu/ssl/datasets/ChestXray/COVID-QU-Ex/Infection Segmentation Data/'

# dataset name
_C.DATA.DATASET = 'NIHchest'
# dataset lists and labels
_C.DATA.TRAIN_LIST = '/mnt/nvme1n1/zhouziyu/Swin-Transformer/data/data_split/COVID-QU-Ex/train_mask.txt'
_C.DATA.VAL_LIST = '/mnt/nvme1n1/zhouziyu/Swin-Transformer/data/data_split/COVID-QU-Ex/val_mask.txt'
_C.DATA.TEST_LIST = '/mnt/nvme1n1/zhouziyu/Swin-Transformer/data/data_split/COVID-QU-Ex/test_mask.txt'
...
def get_config_ConvidQuEx(args):
