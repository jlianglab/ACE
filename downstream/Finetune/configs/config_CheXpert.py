...
_C.OUTPUT = '/sda/zhouziyu/ssl/downstream_checkpoints/CheXpert/'
...
_C.DATA.DATA_PATH = '/sda/zhouziyu/ssl/datasets/ChestXray/CheXpert/'
# dataset name
_C.DATA.DATASET = 'CheXpert'
# dataset lists and labels
_C.DATA.TRAIN_LIST = "/sda/zhouziyu/ssl/datasets/ChestXray/CheXpert/CheXpert-v1.0/train.csv"
_C.DATA.VAL_LIST = "/sda/zhouziyu/ssl/datasets/ChestXray/CheXpert/CheXpert_valtest/val_labels.csv"
_C.DATA.TEST_LIST = "/sda/zhouziyu/ssl/datasets/ChestXray/CheXpert/CheXpert_valtest/test_labels.csv"
