...
_C.OUTPUT = '/sda/zhouziyu/ssl/downstream_checkpoints/JSRT/'
...
_C.DATA.DATA_PATH = '/sda/zhouziyu/ssl/datasets/JSRT/All247images/images_png/'
_C.DATA.MASK_HEART = '/sda/zhouziyu/ssl/datasets/JSRT/All247images/masks/heart_png'
_C.DATA.MASK_CLA1 = '/sda/zhouziyu/ssl/datasets/JSRT/All247images/masks/left_clavicle_png'
_C.DATA.MASK_CLA2 = '/sda/zhouziyu/ssl/datasets/JSRT/All247images/masks/right_clavicle_png'
_C.DATA.MASK_LUNG1 = '/sda/zhouziyu/ssl/datasets/JSRT/All247images/masks/left_lung_png'
_C.DATA.MASK_LUNG2 = '/sda/zhouziyu/ssl/datasets/JSRT/All247images/masks/right_lung_png'
# dataset name
_C.DATA.DATASET = 'NIHchest'
# dataset lists and labels
_C.DATA.TRAIN_LIST = '/sda/zhouziyu/ssl/datasets/JSRT/All247images/jsrt_split/train.txt'
_C.DATA.VAL_LIST = '/sda/zhouziyu/ssl/datasets/JSRT/All247images/jsrt_split/val.txt'
_C.DATA.TEST_LIST = '/sda/zhouziyu/ssl/datasets/JSRT/All247images/jsrt_split/test.txt'
...
def update_config(config, args):
    ...
    if config.DATA.IMG_SIZE == 448:
        if config.LINEAR_PROB:
            config.OUTPUT = os.path.join(config.OUTPUT, config.PRETRAIN_MODE+config.BACKBONE+'_linearprob_448_'+config.SEG_PART+config.DATA.FOLD)
        else:
            config.OUTPUT = os.path.join(config.OUTPUT, config.PRETRAIN_MODE+config.BACKBONE+'_448_'+config.SEG_PART+'_ratio'+config.RATIO+config.DATA.FOLD)
    elif config.DATA.IMG_SIZE == 224:
        config.OUTPUT = os.path.join(config.OUTPUT, config.PRETRAIN_MODE+config.BACKBONE+'_224_'+config.SEG_PART+config.DATA.FOLD)
    elif config.DATA.IMG_SIZE == 518:
        config.OUTPUT = os.path.join(config.OUTPUT, config.PRETRAIN_MODE+config.BACKBONE+'_518_'+config.SEG_PART+'_ratio'+config.RATIO+config.DATA.FOLD)
    elif config.DATA.IMG_SIZE == 512:
        config.OUTPUT = os.path.join(config.OUTPUT, config.PRETRAIN_MODE+config.BACKBONE+'_512_'+config.SEG_PART+'_ratio'+config.RATIO+config.DATA.FOLD)
    ...
    if config.DATA.IMG_SIZE == 224:
        ...
        config.DATA.CROP_SIZE = 576
    elif config.DATA.IMG_SIZE == 518:
        config.DATA.CROP_SIZE = 592
