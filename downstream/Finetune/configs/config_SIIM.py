...
_C.OUTPUT = '/sda/zhouziyu/ssl/downstream_checkpoints/SIIM/'
...
_C.DATA.IMAGE = '/sda/zhouziyu/ssl/datasets/SIIM/image_all_dcm'
_C.DATA.MASK = '/sda/zhouziyu/ssl/datasets/SIIM/mask_all_png'

# # dataset name
_C.DATA.DATASET = 'NIHchest'
# dataset lists and labels
_C.DATA.TRAIN_LIST = '/nvme1n1/zhouziyu/Swin-Transformer/data/data_split/SIIM/train.txt'
_C.DATA.VAL_LIST = '/nvme1n1/zhouziyu/Swin-Transformer/data/data_split/SIIM/val.txt'
_C.DATA.TEST_LIST = '/nvme1n1/zhouziyu/Swin-Transformer/data/data_split/SIIM/test.txt'
...
def update_config(config, args):
    ...
    if config.DATA.IMG_SIZE == 448:
        if config.LINEAR_PROB:
            ...
            config.OUTPUT = os.path.join(config.OUTPUT, config.PRETRAIN_MODE+config.BACKBONE+'_448_'+'ratio'+config.RATIO+config.DATA.FOLD)
        ...
        config.OUTPUT = os.path.join(config.OUTPUT, config.PRETRAIN_MODE+config.BACKBONE+'_512_'+'ratio'+config.RATIO+config.DATA.FOLD)
