...
if __name__ == "__main__":
    ...
    parser.add_argument('--root_dir', type=str, default='co-segmentation/root_image',  help='The root dir of image pairs.')
    parser.add_argument('--save_dir', type=str, default='co-segmentation/save_image', help='The root save dir for image pairs results.')
    ...
    parser.add_argument('--num_parts', default=3, type=int, help="Number of common object parts.")
