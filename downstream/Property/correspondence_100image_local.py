...
if __name__ == "__main__":
    ...
    parser.add_argument('--pretrain_mode', type=str, choices=['LeADER','adamv2','PEAC','ACE','Lamps','RAD-DINO','CheSS','EVA-X', 'ACE-v2','ark'], default='ark', help="Choose the pretraining mode")
    ...
    # parser.add_argument('--embd_dir', type=str, default='/mnt/sda/zhouziyu/ssl/datasets/ChestXray/NIHChestX-ray14/landmark_embd_fromIN_ACEv2_swinv1_100imgs_crop448local',  help='key image embeddings saving dictionary.')
    parser.add_argument('--embd_dir', type=str, default='/sda/zhouziyu/ssl/datasets/ChestXray/NIHChestX-ray14/landmark_embd_ark_100imgs_crop448local',  help='key image embeddings saving dictionary.')
    parser.add_argument('--error_file', type=str, default='./correspondence/error_ark_100imgs_crop224local.csv',  help='save the errors of each predicted landmark.')
    ...
    parser.add_argument('--crop_size', type=int, default=448,  help="crop size of each landmark")
    ...
    # positions = [2,34] # query positions
