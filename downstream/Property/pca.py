...
if __name__ == "__main__":
    ...
    parser.add_argument('--root_dir', type=str, default='./pics/',  help='The root dir of image pairs.')
    parser.add_argument('--save_dir', type=str, default='./savess/', help='The root save dir for image pairs results.')
    ...
    parser.add_argument('--n_components', default=6, type=int, help="number of pca components to produce.")
