...
if __name__ == "__main__":
    ...
    parser.add_argument('--error_file', type=str, default='./correspondence/error_ACEv2_swinv2_interpolation_Lclavicle.csv',  help='save the errors of each predicted landmark.')
