...
def triangulation(A,B,C,P, image, model, device, args=None):
    ...
    # similarity = (similarity1[0,0]+ similarity2[0,0]+similarity3[0,0])/3.0
    # embd_P_pred = (embd_P1_pred + embd_P2_pred + embd_P3_pred) / 3.0
    # return embd_P, embd_P_pred, similarity
...
if __name__ == "__main__":
    ...
    parser.add_argument('--error_file', type=str, default='./correspondence/error_ACEv2_swinv2_triangulation_Lclavicle_intra_patient.csv',  help='save the errors of each predicted landmark.')
    ...
    for query_img in querydict.keys(): # 100 query images
        ...
        try:
            ...
            print(f"Error in triangulation for query image {query_img} at position {pos_num}: {e}")
            continue
