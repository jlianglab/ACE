...
class ImageFolder_vindr(DatasetFolder):
...
class ChestX_ray14(Dataset):
  ...
  def __init__(self, pathImageDirectory, pathDatasetFile, augment, data_granularity=0, epoch=0, num_class=14, anno_percent=100):
  ...
  def __getitem__(self, index):
    ...
    base_crop_size = int(min(h, w) * self.data_granularity)

    if self.augment != None: imageData = self.augment(imageData, base_crop_size, self.epoch)
